                ...
                <table class="min-w-full divide-y divide-gray-200 ">
                  <thead class="bg-accent ">
                    <tr>
                      ...
                      <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 F">
                        Quantity
                      </th>
                      <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 F">
                        Actions
                    ...
                    <tr>
                      ...
                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                        <div class="flex items-center gap-x-6">
                          ...
                          <button class="text-red-500 transition-colors duration-200 hover:text-primary focus:outline-none">
                            Delete
                          </button>
                        </div>
                      </td>
